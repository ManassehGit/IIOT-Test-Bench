    ...
    <nav className="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div className="container-fluid d-flex flex-column p-0">
                ...
                <ul className="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li className="nav-item" role="presentation"><Link className="nav-link" to="/configpubsub" ><i className="fas fa-user"></i><span>Configure Pub and Sub </span></Link></li>
                    ...
                    <li className="nav-item" role="presentation"><Link className="nav-link" to="/visualize"><i className="fas fa-user-circle"></i>Visualize</Link></li>
                </ul>
